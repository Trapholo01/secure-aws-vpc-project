...
This project demonstrates the design and implementation of a **secure, tiered AWS VPC architecture** using the AWS Management Console. The infrastructure ensures that resources in a **private subnet can access the internet securely** via a NAT Gateway, while remaining **inaccessible from direct inbound public traffic**.
...
This project demonstrates a foundational understanding of AWS VPC networking and security principles. It showcases how to securely isolate private resources while still allowing controlled internet access using AWS-native services.
